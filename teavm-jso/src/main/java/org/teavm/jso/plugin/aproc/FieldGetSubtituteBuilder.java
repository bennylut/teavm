 ...
 * @author bennyl
 */
public class FieldGetSubtituteBuilder extends DelegatingSubstituteBuilder<GetFieldInstruction, FieldGetSubtituteBuilder> {

    public FieldGetSubtituteBuilder(SubstituteBuilder s) {
        super(s);
        assignReceiver(getInstruction().getReceiver(), getInstruction().getFieldType(), ConversionMode.TO_JAVA);
    }
